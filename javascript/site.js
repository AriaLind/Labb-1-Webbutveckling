...
const Pizzas =[
    {
        name: "Kebab Pizza",
        ingredients: "Kebab meat, Red onion, Bell peppers, Tomatoes, Jalapeños, Mozzarella cheese, Pizza sauce or tomato sauce, Kebab sauce or garlic sauce",
        price: 7.99,
        imageUrl: "../img/Kebab Pizza.webp",
        imageAlt: "KebabPizza.webp",
        description: "Our signature kebab pizza is a tantalizing blend of succulent kebab meat, crisp red onions, vibrant bell peppers, zesty tomatoes, and spicy jalapeños atop a rich tomato or pizza sauce base. Topped with creamy mozzarella cheese and your choice of kebab or garlic sauce, each bite bursts with flavor and texture, creating a culinary experience that's simply irresistible."
    },
    {
        name: "Salami Pizza",
        ingredients: "Salami, Mozzarella cheese, Tomato sauce or pizza sauce, Red onion, Bell peppers, Black olives (optional), Mushrooms (optional), Fresh basil (optional)",
        price: 6.99,
        imageUrl: "../img/Salami Pizza.webp",
        imageAlt: "SalamiPizza.webp",
        description: "Indulge in our classic Salami Pizza, crafted with savory salami slices, velvety mozzarella cheese, and tangy tomato or pizza sauce. Enhanced with the aromatic notes of red onions, crisp bell peppers, and optional black olives, mushrooms, or fresh basil, it's a symphony of flavors that will delight your taste buds with every bite."
    },
    {
        name: "Calzone",
        ingredients: "Salami, Ricotta cheese, Mozzarella cheese, Tomato sauce or marinara sauce, Black olives (optional), Mushrooms (optional), Fresh spinach (optional), Garlic (optional)",
        price: 6.99,
        imageUrl: "../img/Calzone.webp",
        imageAlt: "Calzone.webp",
        description: "Savor the essence of Italy with our delectable Calzone. Stuffed with premium salami, creamy ricotta cheese, and gooey mozzarella, it's a taste of Italian tradition. Enjoy the medley of flavors from zesty tomato sauce or marinara, complemented by optional black olives, mushrooms, fresh spinach, and garlic. Every bite is a journey through the rustic flavors of Italy, wrapped in a golden crust for a perfect culinary experience."
    },
    {
...
Pizzas.forEach(pizza => {
    ...
    pizzaOrderButton.textContent = 'Order';
    pizzaOrderButton.addEventListener('click', function() {addToCart(pizza)})
